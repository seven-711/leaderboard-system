    ...
    `;
      ...
      void main() {
        ...
        for(float i = 0.0; i < 100.0; i++) {
          ...
          // Horizontal 3-color gradient (left -> center -> right)
          float xPos = pos.x / uPillarWidth; // Normalize to roughly -1 to 1
          vec3 gradient;
          if (xPos < 0.0) {
            gradient = mix(uCenterColor, uLeftColor, smoothstep(0.0, -1.0, xPos));
          } else {
            gradient = mix(uCenterColor, uRightColor, smoothstep(0.0, 1.0, xPos));
          }
    ...
    `;
        ...
        const material = new THREE.ShaderMaterial({
            ...
            uniforms: {
                ...
                uCenterColor: { value: parseColor(centerColor) },
