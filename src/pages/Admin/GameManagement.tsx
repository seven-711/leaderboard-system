        ...
        <div className="space-y-8 animate-fade-in">
            <div className="flex justify-between items-center">
                ...
                <button
                    ...
                    className="bg-[var(--color-neon-green)] text-black font-bold px-4 py-2 rounded-lg hover:bg-[var(--color-neon-green-hover)] transition-colors flex items-center gap-2"
                >
